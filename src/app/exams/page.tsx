...
import { CalendarClock, ClipboardList, Clock, Loader2, PlayCircle } from "lucide-react";
    ...
    <AppShell>
      <div className="mx-auto max-w-4xl space-y-6">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">Timed exam papers set by your teacher or admin.</p>
        </div>
        ...
        {papers === undefined ? (
          ...
          <EmptyState
            ...
            description="Check back once your teacher or admin has published an exam paper."
          />
        ) : (
